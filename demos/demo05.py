...
# Demonstrate the difference between colorultra initialized with wrapping on and off.
...
import sys
import fixpath
from colorultra import AnsiToWin32, init, Fore
...
print('%sUnwrapped CYAN, using the file parameter to write via colorultra the AnsiToWin32 function.' % Fore.CYAN, file=AnsiToWin32(sys.stdout))
